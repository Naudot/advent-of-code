...
{
	public class DayEighteen : Day2020
	{
		protected override object ResolveFirstPart()
		{
			InfixExpressionCalculator.Operators = new Dictionary<char, int>()
			{
				{'+', 1},
				{'*', 1}
			};
			...
			{
				result += InfixExpressionCalculator.EvaluateInfix(input[i]);
			}
	...
	// Credits to : https://github.com/jdbrowndev/infix-expression-calculator/blob/master/InfixExpressionCalculator/InfixExpressionCalculator.cs
